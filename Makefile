...
# Sources
SRCS = main.c startup_stm32f411.s spi.c st7789.c i2s.c dma.c sdcard_spi.c sdcard.c fat32.c encoder.c sequencer_clock.c sequencer.c wav_loader.c audio_mixer.c
